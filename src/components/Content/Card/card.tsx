...
X            <button className="w-full md:max-w-full h-20 md:px-96 px-24 py-4  my-8 text-2xl font-bold text-white bg-black  hover:bg-slate-700 focus:outline-none focus:ring-4 border ">
            </button>
